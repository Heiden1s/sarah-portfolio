    ...
    <Section isGray={false}>
      <div className="w-full flex flex-col">
        <div className="text-center mb-8">
          <h2 className="text-white text-3xl font-handwriting">
            About me
          </h2>
          <div className="w-24 h-1 bg-main-teal mx-auto mt-3 rounded-full"></div>
        </div>

        <div className="flex flex-col-reverse md:flex-row gap-6 px-4 items-center md:items-start">
          ...
          <div className="md:w-1/3 flex justify-center md:justify-start mb-6 md:mb-0">
            <div className="w-48 md:w-56 relative">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-nav-gray rounded-full opacity-20 -z-10"></div>
            </div>
          </div>

          {/* Text Content - Now Second */}
          <div className="md:w-2/3 flex flex-col">
            <div className="bg-card-dark backdrop-blur-sm rounded-lg p-6">
            ...
            <button className="mt-6 border-2 border-white text-white font-handwriting px-6 py-2 rounded-full 
