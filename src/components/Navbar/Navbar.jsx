  ...
  return (
    <nav className="bg-nav-gray w-full z-40">
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        {/* Logo/Title - Always visible and centered on mobile */}
        <a 
          href="#home" 
          onClick={(e) => {
            e.preventDefault();
          ...
          className={`text-white font-mono text-xl md:text-2xl lg:text-3xl px-3 py-2 md:px-5 md:py-3
                     ...
                     mx-auto md:mx-0 ${activeSection === 'home' ? 'text-main-teal' : ''}`}
        >
          Sarah Jafari.art
        </a>
        ...
        <div className="md:hidden flex-none w-8"></div>
      </div>
    </nav>
  );
};
...
const NavLink = ({ href, children, isActive, onClick }) => {
  return (
    <a
      ...
      className={`text-white font-mono text-xl px-5 py-3
